###############################################################
## Style Name: Community Child
## based on my own color scheme, own graphics since 2016
...
# Updates
##
## phpBB-Version 3.2.0-RC2 - 14.12.2016
## phpBB-Version 3.2.1 - 07.08.2017
##
# Created as a Child-Style for phpBB-3.2.2 - 18.04.2018
# by Talk19Zehn ( https://www.ongray-design.de ) some changes
# with credits to Melmac ( https://www.phpbb.de/phpbbde/team/#group72315 , https://www.phpbb.de/phpbbde/team/#group27563 )
# for a first validate and his feedback about zero errors.
##
## phpBB 3.2.3 - 03.10.2018
## phpBB 3.2.4 - 28.11.2018
## phpBB 3.2.5 - 29.12.2018
#
## phpBB 3.2.5 - 04.04.2019, 19.04.2019 style-version: 1.1.4
## phpBB 3.2.7 - 15.06.2019 style-version: 1.1.5
## phpBB 3.2.8 - 23.09.2019 style-version: 1.1.6
## phpBB 3.2.9 - 08.01.2020 style-version: 1.1.7
## phpBB 3.2.9 - 29.01.2020 style-version: 1.1.8
## phpBB 3.2.10 - 23.07.2020, 13.08.2020 style-version: 1.1.9
## phpBB 3.2.11 - 12.11.2020, style-version: 1.1.10
#
## Credits: A small (one) element into the Header-Image are based on Style AERO-BLUE - Styleauthor John Olson ( https://www.phpbb.com/community/viewtopic.php?f=596&t=2406106 ) with kind permission.
#
###############################################################
...
## phpbb 3.3.0, 15.05.2021, style_version = 3.3.0.10, few css adjustments
## phpbb 3.3.1 - 11.08.2020, style-version: 3.3.1, phpbb 3.3.1 - 13.05.2021, style-version: 3.3.1.1
